...
public class ClockAppWidgetProvider extends AppWidgetProvider
{
	...
	public void onUpdate( Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds )
	{
		...
		for( int i = 0; i < N; i++ )
		{
			...
			boolean use24 = CleanClockWidgetConfigure.loadPref( context, appWidgetId, Constants.PREF_24HOUR );
			boolean useShadow = CleanClockWidgetConfigure.loadPref( context, appWidgetId, Constants.PREF_SHADOW );
